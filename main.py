...
janela.iconbitmap("calculadora_cor.ico")
...
botão_converter = customtkinter.CTkButton(janela, text="Converter", command=converter_moeda, font=("Arial", 20), hover_color="blue")
...
for codigo_moeda in moedas_disponiveis:
    ...
    texto_moeda = customtkinter.CTkLabel(lista_moedas, text=f"{codigo_moeda}: {nome_moeda}", font=("", 15))
    texto_moeda.pack()
...
botão_converter.pack(padx=10, pady=20)
texto_cotacao_moeda.pack(padx=10, pady=10)
lista_moedas.pack(padx=10, pady=5)
